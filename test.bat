...
python check_true_false.py Tests/testKB.txt Tests/TestAddKnow.txt Tests/defFalse.txt

python check_true_false.py Tests/wrongTestKB.txt Tests/TestAddKnow.txt Tests/bothTrueFalse.txt
